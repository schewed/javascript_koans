describe("About Objects", function () {
  ...
  it("should know that properties can be added and deleted", function () {
    ...
    expect("secretary" in meglomaniac).toBe(undefined); // or null?
  ...
  it("should use prototype to add to all objects", function () {
    ...
    expect(simpleCircle.colour).toBe(undefined); // or null?
    ...
    expect(simpleCircle.describe()).toBe("This cirlce has a radius of: " 10);
